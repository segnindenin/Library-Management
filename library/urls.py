...
urlpatterns = [
    ...
    path('update-adherent/<int:adherent_id>/', views.update_adherent, name="update-adherent"),
    path('delete-adherent/<int:adherent_id>/', views.delete_adherent, name="delete-adherent"),
